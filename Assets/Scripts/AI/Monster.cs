...
public class Monster : MonoBehaviour {
    ...
    //How high above the ground is the monster's origin?
    public float originVertOffset = 0.0f;
    ...
    public bool MoveToPlayer() {
		...
		Vector3 movementDest = HexConst.HexToWorldCoord(pathToPlayer[movementSpeed][0], pathToPlayer[movementSpeed][1], pathToPlayer[movementSpeed][2]) + new Vector3(0, originVertOffset, 0);
		...
		Vector3 nextWaypoint = HexConst.HexToWorldCoord(pathToPlayer[curPInd + 1][0], pathToPlayer[curPInd + 1][1], pathToPlayer[curPInd + 1][2]) + new Vector3(0, originVertOffset, 0);
